...
function first_and_second() {
    var new_array = [];     /*JS Literal Notation */
    var array_new = new Array();    /*JS Object Notation */
    document.write("<p>They are Declared as:<br/>JS Literal Notation:<br>var new_array = [];<p>");
...
function tenth() {
    var cars = ["Mustang"," Lamborghini"," Nissan"," Rolce Royes"];
    document.write("<h2>Favourite Cars</h2><br/>"+cars)
    var first_index = cars.indexOf("Mustang");
    var last_index = cars.indexOf(" Rolce Royes");
...
function eleven() {
    var students = ["Hamza", " Hasan", " Asjad", " Omar"];
...
function fourteen() {
    var fruits = ["Apple"," Peach"," Leeche"," Cherry"," Strawberry"];
